...
import com.prashant.instaclone.Utils.CommentListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(com.prashant.instaclone.ViewComments.this)
        ...
        mpost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!mComment.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(com.prashant.instaclone.ViewComments.this, "you can't post a blank comment", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
